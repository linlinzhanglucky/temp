...
class MPMBeamSimulator:
    def __init__(
        ...
        ti.init(arch=ti.cuda, kernel_profiler=True, random_seed=10)  # Use 'ti.cuda' if your GPU supports it
...
if __name__ == "__main__":
    simulator = MPMBeamSimulator(n=64, num_particles=4900, dt=1e-4, frames=20, steps_per_frame=350, output_dir="mpm_output_0527", create_video = False)
    Es = [12.0e4, 26.0e4]
    Nus = [0.01, 0.45]
    Rhos = [1.0, 4.0]
    Es   = np.linspace(12.0e4, 26.0e4, num=30).tolist()
