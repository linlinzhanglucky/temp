...
if avg_val_losses:
    ...
    plt.plot(epochs, avg_val_losses_red, label="Validation Loss Red - Stiffness/Density", linestyle='--', color='red', alpha=1.0)
    plt.plot(epochs, avg_val_losses_green, label="Validation Loss Green - Density", linestyle='--', color='green', alpha=1.0)
    plt.plot(epochs, avg_val_losses_blue, label="Validation Loss Blue - Possion", linestyle='--', color='blue', alpha=1.0)
...
plt.plot(epochs, np.log10(avg_val_losses_red), label="Validation Loss Red - Stiffness/Density", linestyle='--', color='red', alpha=1.0)
plt.plot(epochs, np.log10(avg_val_losses_green), label="Validation Loss Green - Density", linestyle='--', color='green', alpha=1.0)
plt.plot(epochs, np.log10(avg_val_losses_blue), label="Validation Loss Blue - Possion", linestyle='--', color='blue', alpha=1.0)
