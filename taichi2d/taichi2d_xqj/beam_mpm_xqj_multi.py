...
if __name__ == "__main__":
    simulator = MPMBeamSimulator(n=64, num_particles=4900, dt=1e-4, frames=frames, steps_per_frame=steps_per_frame, output_dir=output_dir, create_video = False)
    Es = [12.0e4, 26.0e4]
    Nus = [0.01, 0.45]
    Rhos = [1.0, 4.0]
