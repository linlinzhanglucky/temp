...
from dataset_timesformer_acc import BWVideoColorizationDataset
...
def main():
    ...
    train_dataset = BWVideoColorizationDataset(train_input, train_label, num_frames, preload=False, device=device)
    val_dataset = BWVideoColorizationDataset(val_input, val_label, num_frames, preload=False, device=device)
    ...
    if start_epoch > 1:
        ckpt_path = os.path.join(output_dir, "models", f"model_epoch{start_epoch - 1}.pth")
